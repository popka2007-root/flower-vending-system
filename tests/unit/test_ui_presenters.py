...
from flower_vending.ui.viewmodels.screens import DiagnosticsDeviceViewModel
...
class PresenterTests(unittest.TestCase):
    def test_payment_presenter_exposes_simulator_quick_insert_buttons(self) -> None:
        ...
        model = presenter.present_payment(
            ...
            quick_insert_denominations=(100, 500),
        )
        self.assertEqual(tuple(action.action_id for action in model.quick_insert_actions), ("insert_bill:100", "insert_bill:500"))
    ...
    def test_status_presenter_restricted_mode_is_explicit(self) -> None:
        ...
        self.assertEqual(model.title, "Recovery / restricted mode")
